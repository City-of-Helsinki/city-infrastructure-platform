...
DELETE_TEST_PARAMS = (
    ...
    (BarrierPlanFactory, BarrierPlan, BarrierPlanFile, "barrier_plan", "barrierplan"),
    (BarrierRealFactory, BarrierReal, BarrierRealFile, "barrier_real", "barrierreal"),
    (MountPlanFactory, MountPlan, MountPlanFile, "mount_plan", "mountplan"),
    (MountRealFactory, MountReal, MountRealFile, "mount_real", "mountreal"),
    (
        RoadMarkingPlanFactory,
        RoadMarkingPlan,
        RoadMarkingPlanFile,
...
FILE_UPLOAD_PARAMS = (
    ...
    (BarrierPlanFactory, BarrierPlan, "barrierplan"),
    (BarrierRealFactory, BarrierReal, "barrierreal"),
    (MountPlanFactory, MountPlan, "mountplan"),
    (MountRealFactory, MountReal, "mountreal"),
    (RoadMarkingPlanFactory, RoadMarkingPlan, "roadmarkingplan"),
    (RoadMarkingRealFactory, RoadMarkingReal, "roadmarkingreal"),
    (SignpostPlanFactory, SignpostPlan, "signpostplan"),
    (SignpostRealFactory, SignpostReal, "signpostreal"),
    (TrafficLightPlanFactory, TrafficLightPlan, "trafficlightplan"),
    (TrafficLightRealFactory, TrafficLightReal, "trafficlightreal"),
    (TrafficSignPlanFactory, TrafficSignPlan, "trafficsignplan"),
    (TrafficSignRealFactory, TrafficSignReal, "trafficsignreal"),
)
