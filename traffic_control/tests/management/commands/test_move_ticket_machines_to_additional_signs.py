...
class TestMoveTicketMachinesToAdditionalSignsCommand:
    ...
    def test_command_source_field_concatenation(self, ticket_machine_device_types):
        ...
        # source_id is the original TrafficSignPlan ID for traceability
        assert new_sign.source_id == str(ticket_machine.id)
