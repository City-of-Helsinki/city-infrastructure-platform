...
def test__wfs_signpost__gml(model_name: str, factory) -> None:
    """Test that signpost WFS GML response contains correct feature data.

    Args:
        model_name (str): The WFS type name for the signpost model.
        factory: The factory class used to create the test instance.
...
@pytest.mark.django_db
def test__wfs_signpost__geojson(model_name: str, factory) -> None:
    """Test that signpost WFS GeoJSON response contains correct feature data.
