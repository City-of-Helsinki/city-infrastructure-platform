...
@pytest.mark.django_db
def test__signpost_plan_export_real_import(has_mount_plan, has_mount_real, has_parent_plan, has_parent_real):
    ...
    plan_obj = get_signpost_plan(mount_plan=mount_plan, parent=parent_plan)
