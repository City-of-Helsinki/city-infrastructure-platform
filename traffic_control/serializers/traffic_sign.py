...
class TrafficSignPlanFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
...
class TrafficSignRealFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
