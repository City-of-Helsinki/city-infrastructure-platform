...
class MountPlanFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
        model = MountPlanFile
        fields = "__all__"
...
class MountRealFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
        model = MountRealFile
        fields = "__all__"
