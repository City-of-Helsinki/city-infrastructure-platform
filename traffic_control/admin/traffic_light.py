...
class TrafficLightPlanAdmin(
    ...
    def get_queryset(self, request):
        # NOTE: This get_queryset was generated by the admin_assist_get_queryset command. If it
        # in need of updates try generating a new one with the command again before editing
        # manually, and take the implementation with a grain of salt
