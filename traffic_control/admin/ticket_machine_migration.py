...
class MigrationRecordAdminMixin:
...
class TicketMachineMigrationRunAdmin(admin.ModelAdmin):
    ...
    def delete_queryset(self, request, queryset):
        ...
        This is called by Django's built-in "delete selected objects" action.
        """
        # Filter to only deletable runs (dry-run or failed)
...
class TicketMachineMigrationPlanRecordAdmin(MigrationRecordAdminMixin, admin.ModelAdmin):
...
class TicketMachineMigrationRealRecordAdmin(MigrationRecordAdminMixin, admin.ModelAdmin):
