...
from traffic_control.serializers.common import EwktPointField, HideFromAnonUserSerializerMixin, HidePrivateFileUrlMixin


class FurnitureSignpostPlanFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
...
class FurnitureSignpostRealFileSerializer(HidePrivateFileUrlMixin, serializers.ModelSerializer):
    class Meta:
