...
class CityFurnitureFunctionType(Enum):
    ...
    class Labels:
        ...
        POSTBOX = _("Postbox")
        EMERGENCY_CALL_FIXTURE = _("Emergency call fixture")
        FIRE_DETECTOR = _("Fire detector")
        POLICE_CALL_POST = _("Police call post")
        ...
        RAIL_LEVEL_CROSSING = _("Rail level crossing")
        GATE = _("Gate")
        STREETLAMP_LATERN_OR_CANDELABRA = _("Streetlamp, latern or candelabra")
        COLUMN = _("Column")
        LAMP_POST = _("Lamp post")
        FLAGPOLE = _("Flagpole")
        STREET_SINK_BOX = _("Street sink box")
        RUBBISH_BIN = _("Rubbish bin")
        CLOCK = _("Clock")
        DIRECTIONAL_SPOT_LIGHT = _("Directional spot light")
        ...
        ENTRANCE_SHAFT = _("Entrance shaft")
        ...
        WAYSIDE_SHRINE = _("Wayside shrine")
        CROSSROADS = _("Crossroads")
        CROSS_ON_THE_SUMMIT_OF_A_MOUNTAIN = _("Cross on the summit of a mountain")
        FOUNTAIN = _("Fountain")
        BLOCK_MARK = _("Block mark")
        BOUNDARY_POST = _("Boundary post")
        BENCH = _("Bench")
        OTHERS = _("Others")
